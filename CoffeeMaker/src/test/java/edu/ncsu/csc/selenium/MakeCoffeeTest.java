...
public class MakeCoffeeTest extends SeleniumTest {
    ...
    public void testValidMakeCoffee () throws Exception {
        makeCoffee( "Coffee", 50, 0, 3, 7, 2, 50, "Coffee was made" );
        makeCoffee( "Coffee", 50, 5, 0, 7, 2, 50, "Coffee was made" );
        makeCoffee( "Coffee", 50, 5, 3, 0, 2, 50, "Coffee was made" );
        makeCoffee( "Coffee", 50, 5, 3, 0, 2, 50, "Coffee was made" );
        makeCoffee( "Coffee", 50, 5, 3, 7, 0, 50, "Coffee was made" );
        makeCoffee( "Coffee", 50, 5, 3, 7, 2, 100, "Coffee was made" );
        makeCoffee( "Coffee", 50, 5, 3, 7, 2, 51, "Coffee was made" );
    }
    ...
    public void testInvalidMakeCoffee () throws Exception {
        makeCoffee( "Coffee", 50, 0, 3, 7, 2, 49, "Sale rejected." );
        makeCoffee( "Coffee", 50, 5, 0, 7, 2, -1, "Sale rejected." );
    }
